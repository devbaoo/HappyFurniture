        ...
        <div className="w-full px-2 md:px-14 lg:px-24 mx-auto max-w-[1650px] py-3 md:py-3 pt-24 md:pt-24 font-sans bg-white relative">
            ...
            <section className="mb-6 md:mb-7 pt-1">
                ...
                <div className="flex justify-center">
                    <button type="button" className={`inline-flex items-center justify-center px-8 py-2.5 text-xs font-semibold tracking-[0.14em] bg-white text-stone-800 ring-[0.5px] ring-stone-400 hover:ring-[#3c4a28] hover:bg-[#3c4a28] hover:text-white transition-all duration-200 ${lang === "vi" ? "normal-case" : "uppercase"}`}>
                        {n.viewMore[lang]}
                    </button>
                </div>
            </section>
            ...
            <section className="mb-6 md:mb-7">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-5 md:gap-y-6 mb-2 md:mb-2.5">
                    <div className="flex flex-col space-y-3">
                        {[1, 2, 3].map((i) => (
                            <div key={`tb-l-${i}`} className="flex gap-2.5 md:gap-3 group cursor-pointer">
                                ...
                                <div className="flex flex-col justify-center">
                                    <h3 className={`font-heading font-normal text-black mb-1 text-base sm:text-lg leading-[1.1] tracking-[0.04em] group-hover:text-gray-600 transition-colors ${lang === "vi" ? "normal-case" : "uppercase"}`}>{n.teamBuildingTitle[lang]}</h3>
                    ...
                    <div className="flex flex-col space-y-3">
                        {[1, 2, 3].map((i) => (
                            <div key={`ft-r-${i}`} className="flex gap-2.5 md:gap-3 group cursor-pointer">
                                <div className="w-48 h-32 sm:w-64 sm:h-40 bg-gray-200 shrink-0 overflow-hidden">
                                ...
                                <div className="flex flex-col justify-center">
                                    <h3 className={`font-heading font-normal text-black mb-1 text-base sm:text-lg leading-[1.1] tracking-[0.04em] group-hover:text-gray-600 transition-colors ${lang === "vi" ? "normal-case" : "uppercase"}`}>{n.factoryTourTitle[lang]}</h3>
